...
#if (defined(__SSE2__) || defined(WEBP_MSC_SSE2) || defined(WEBP_USE_SIMDE) || defined(WEBP_USE_EMSCRIPTEN_SIMD)) && \
...
#if (defined(__SSE4_1__) || defined(WEBP_MSC_SSE41) || defined(WEBP_USE_SIMDE) || defined(WEBP_USE_EMSCRIPTEN_SIMD)) && \
