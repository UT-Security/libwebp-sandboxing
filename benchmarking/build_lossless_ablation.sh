...
buildlibrary() {
    ...
    if [ "$DIRECT_CALL" = "true" ]; then
        ...
        NATIVE_COMPILER_DEFINES="${NATIVE_COMPILER_DEFINES} -DWEBP_WASM_LOSSLESS_DIRECT_CALL"
        NATIVESIMD_COMPILER_DEFINES="${NATIVESIMD_COMPILER_DEFINES} -DWEBP_WASM_LOSSLESS_DIRECT_CALL -DWEBP_WASM_LOSSLESS_SIMD_DIRECT_CALL"
    fi
